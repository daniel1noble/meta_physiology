...
Of the studis that said 'yes' how many actually modelled it or accounted for it?
```{r}
...
Of the studis that are weighted how many actually resported measures of heterogenity?
```{r}

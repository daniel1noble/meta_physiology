...
Finally, we note that, by using the basic properties of variance and the delta method, one can derive sampling variance for most effect size measures. For instances, these methods allowed us to derive sampling variance for 'new' effect sizes (e.g. $lnQ_{10}$; see the main text) and were used in @Nakagawa2015 and @Senior2020. We also refer the reader to @Nakagawa2017ab for additional details on the Delta method.

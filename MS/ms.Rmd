...
$$ I^2_{hetero} = \frac{\sigma^2_{fixed}}{\sigma^2_{fixed} + \sigma^2_{total}} $$

The $I^2_{hetero}$ provides a formal means to assess just how much variation in effects is teh result of known heterogeneity at the effect size level, driven by continuous moderators such as dosage, temperature, salinity, and even pH. $I^2_{hetero}$ maybe a useful measure to provide to help readers understand just how much effec variation can result from the specific treatment application. 

...
```{r, class.source='klippy', results = 'hide', message=FALSE}
...
# This method should be similar from clubSandwich
VCV_ARR2 <- clubSandwich::impute_covariance_matrix(data_CS1a$Var_ARR, cluster = "shared_measurement_ID", r =0.5)
```
...
Model_CS1a_MLMA <- metafor::rma.mv(ARR ~ 1, V = VCV_ARR2, 
                   method="REML",
...
VCV_ARRD <- clubSandwich::impute_covariance_matrix(data_CS1b$Var_ARRD, cluster = "shared_measurement_ID", r =0.5)
```

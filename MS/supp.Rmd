...
pacman::p_load(png, jpeg, pander, cowplot, flextable, tidyverse, metafor, orchaRd, here)
...
download.file(url="https://ndownloader.figshare.com/files/7714777", destfile = "CaseStudy1.csv")

data_CS1 <- read.csv(here("CaseStudy1.csv"))

```

# Case Study 2:
```{r class.source='klippy'}
download.file(url="REPLACE URL FROM OSF HERE", destfile = "CaseStudy2.csv")

data_CS1 <- read.csv(here("CaseStudy2.csv"))
